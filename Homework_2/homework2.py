...
for timeStep in range(1,Nsteps):
  ...
  q_new, error = objfun(q0, u0, dt, tol, maximum_iter, m, mMat, EI, EA, P_load,
                        pNode, deltaL, free_index)
  if error < 0:
